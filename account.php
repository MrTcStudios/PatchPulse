...
<main class="main-wrapper" id="main">
    ...
    <div class="scanner-section">
        ...
        <div class="acc-grid">
            ...
            <!-- Change Password -->
            <div class="acc-card">
                <h3><span class="icon">🔒</span> <?= t('account.password.title') ?></h3>
                <form action="dataBase/change_password.php" method="post">
                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken) ?>">
                    <input type="password" class="acc-input" name="current_password" placeholder="<?= t('account.password.current') ?>" required>
                    <input type="password" class="acc-input" name="new_password" placeholder="<?= t('account.password.new') ?>" required minlength="8">
                    <input type="password" class="acc-input" name="confirm_new_password" placeholder="<?= t('account.password.confirm') ?>" required>
            ...
            <!-- Change Email -->
            <div class="acc-card">
                <h3><span class="icon">✉️</span> <?= t('account.email.title') ?></h3>
                <form action="dataBase/change_email.php" method="post">
                    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken) ?>">
                    <input type="password" class="acc-input" name="current_password" placeholder="<?= t('account.password.current') ?>" required>
                    <input type="email" class="acc-input" name="new_email" placeholder="<?= t('account.email.new') ?>" required>
            ...
            <!-- Activity Logs -->
            <div class="acc-card">
                <h3><span class="icon">📋</span> <?= t('account.logs.title') ?></h3>
                <div class="log-list">
                    <?php
                    ...
                    <?php if (!$has_logs): ?><p style="color:#bbb;font-size:0.88rem"><?= t('account.logs.empty') ?></p><?php endif; ?>
                </div>
            ...
            <!-- Scans -->
            <div class="acc-card">
                <h3><span class="icon">🔍</span> <?= t('account.scans.title') ?></h3>
                <div class="log-list">
                    <?php
                    ...
                    <?php if (!$has_scans): ?><p style="color:#bbb;font-size:0.88rem"><?= t('account.scans.empty') ?></p><?php endif; ?>
                </div>
            </div>

            <!-- Danger Zone -->
            <div class="acc-card full danger-card">
                <h3><span class="icon">⚠️</span> <?= t('account.danger.title') ?></h3>
                ...
                <div class="danger-grid">
                    ...
                    <form action="dataBase/delete_account.php" method="post">
                        <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrfToken) ?>">
                        <input type="password" class="acc-input" name="current_password" placeholder="<?= t('account.danger.delete_pwd') ?>" required>
    ...
    <footer>
        <div class="footer-grid">
            ...
            <div class="footer-col"><h4><?= t('footer.col.contacts') ?></h4><p>Email: support@patchpulse.org</p><a href="https://github.com/MrTcStudios/PatchPulse" target="_blank">GitHub</a></div>
            <div class="footer-col"><h4><?= t('footer.col.resources') ?></h4><a href="home.php#about"><?= t('footer.documentation') ?></a><a href="home.php#faq"><?= t('nav.faq') ?></a></div>
        </div>
